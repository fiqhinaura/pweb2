                ...
                <div class="mb-3">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="id_reservasi"
                            value="<?php echo $reservasiData['id_reservasi']; ?>" />
                    </div>
                    <div class="mb-3">
                        <div class="mb-3">
                            <label for="id_cst" class="form-label">Customer</label>
                            <select type="text" class="form-select" name="id_cst" id="id_cst"
                        ...
                        <div class="mb-3">
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" name="checkin"
                                    value="<?php echo $reservasiData['checkin']; ?>" />
                            </div>
                            ...
                            <div class="mb-3">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" name="checkout"
                                        value="<?php echo $reservasiData['checkout']; ?>" />
                                </div>
